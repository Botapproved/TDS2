...
questions = [
    ...
    Send a HTTPS request to https://httpbin.org/get with the URL encoded parameter email set to 21f2001402@ds.study.iitm.ac.in
    ...
    """Let's make sure you know how to use GitHub. Create a GitHub account if you don't have one. Create a new public repository. Commit a single JSON file called email.json with the value {"email": "21f2001402@ds.study.iitm.ac.in"} and push it.
...
Upload your losslessly compressed image (less than 1,500 bytes)
    """,
    """ Publish a page using GitHub Pages that showcases your work. Ensure that your email address 21f2001402@ds.study.iitm.ac.in is in the page's HTML.
GitHub pages are served via CloudFlare which obfuscates emails. So, wrap your email address inside a:
<!--email_off-->21f2001402@ds.study.iitm.ac.in<!--/email_off-->
...
If a recent change that's not reflected, add ?v=1, ?v=2 to the URL to bust the cache.
    """,
    """ Let's make sure you can access Google Colab. Run this program on Google Colab, allowing all required access to your email ID: 21f2001402@ds.study.iitm.ac.in.
import hashlib
import requests
...
What is the Vercel URL? It should look like: https://your-app.vercel.app/api """,
    """ Create a GitHub action on one of your GitHub repositories. Make sure one of the steps in the action has a name that contains your email address 21f2001402@ds.study.iitm.ac.in. For example:
jobs:
  test:
    steps:
      - name: 21f2001402@ds.study.iitm.ac.in
...
Dear user, please verify your transaction code 65889 sent to 21f2001402@ds.study.iitm.ac.in
Dear user, please verify your transaction code 42512 sent to 21f2001402@ds.study.iitm.ac.in
...
""",
    ...
    Include a step with your email 21f2001402@ds.study.iitm.ac.in in its name
